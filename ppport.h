...
----------------------------------------------------------------------
    ...
    Game-SuperSokohire3/ppport.h -- Perl/Pollution/Portability Version 3.68
    ...
    Use 'perldoc Game-SuperSokohire3/ppport.h' to view the documentation below.
...
=head1 SYNOPSIS
  ...
  perl Game-SuperSokohire3/ppport.h [options] [source files]
  ...
  --strip                     strip all script and doc functionality
                              from Game-SuperSokohire3/ppport.h
...
This version of F<Game-SuperSokohire3/ppport.h> is designed to support operation with Perl
...
Display the version of F<Game-SuperSokohire3/ppport.h>.
...
Tell F<Game-SuperSokohire3/ppport.h> to check for compatibility with the given
Perl version. The default is to check for compatibility with Perl
version 5.003_07. You can use this option to reduce the output
of F<Game-SuperSokohire3/ppport.h> if you intend to be backward compatible only
down to a certain Perl version.

=head2 --cplusplus

Usually, F<Game-SuperSokohire3/ppport.h> will detect C++ style comments and
replace them with C style comments for portability reasons.
Using this option instructs F<Game-SuperSokohire3/ppport.h> to leave C++
comments untouched.
...
Strip all script and documentation functionality from F<Game-SuperSokohire3/ppport.h>.
This reduces the size of F<Game-SuperSokohire3/ppport.h> dramatically and may be useful
if you want to include F<Game-SuperSokohire3/ppport.h> in smaller modules without
increasing their distribution size too much.

The stripped F<Game-SuperSokohire3/ppport.h> will have a C<--unstrip> option that allows
...
F<Game-SuperSokohire3/ppport.h>. Also lists if it must be explicitly requested,
if it has dependencies, and if there are hints or warnings for it.

=head2 --list-unsupported

Lists the API elements that are known not to be FULLY supported by F<Game-SuperSokohire3/ppport.h>,
...
version of Perl that F<Game-SuperSokohire3/ppport.h> supports at all.
...
earlier Perl releases. Use
    ...
    perl Game-SuperSokohire3/ppport.h --list-provided

to see which API elements are provided by Game-SuperSokohire3/ppport.h.
...
also deprecated. You can safely use the supported API, as F<Game-SuperSokohire3/ppport.h>
will provide wrappers for older Perl versions.

=item *

Although the purpose of F<Game-SuperSokohire3/ppport.h> is to keep you from having to concern
...
more C<#define>s in your source code before the inclusion of F<Game-SuperSokohire3/ppport.h>.
...
macro. Just C<#define> the macro before including C<Game-SuperSokohire3/ppport.h>:

    #define DPPP_NAMESPACE MyOwnNamespace_
    #include "Game-SuperSokohire3/ppport.h"
...
F<Game-SuperSokohire3/ppport.h> on your source code. See the next section for
details.

=head1 EXAMPLES

To verify whether F<Game-SuperSokohire3/ppport.h> is needed for your module, whether you
should make any changes to your code, and whether any special defines
should be used, F<Game-SuperSokohire3/ppport.h> can be run as a Perl script to check your
source code. Simply say:

    perl Game-SuperSokohire3/ppport.h
...
use something like this:
    ...
    perl Game-SuperSokohire3/ppport.h --compat-version=5.6.0 --cplusplus --patch=test.diff

If you only want your code to be scanned without any suggestions
for changes, use:

    perl Game-SuperSokohire3/ppport.h --nochanges

You can specify a different C<diff> program or options, using
the C<--diff> option:

    perl Game-SuperSokohire3/ppport.h --diff='diff -C 10'

This would output context diffs with 10 lines of context.

If you want to create patched copies of your files instead, use:

    perl Game-SuperSokohire3/ppport.h --copy=.new

To display portability information for the C<newSVpvn> function,
use:

    perl Game-SuperSokohire3/ppport.h --api-info=newSVpvn

Since the argument to C<--api-info> can be a regular expression,
you can use

    perl Game-SuperSokohire3/ppport.h --api-info=/_nomg$/

to display portability information for all C<_nomg> functions or

    perl Game-SuperSokohire3/ppport.h --api-info=/./
...
If this version of F<Game-SuperSokohire3/ppport.h> is causing failure during
the compilation of this module, please check if newer versions
of either this module or C<Devel::PPPort> are available on CPAN
before sending a bug report.

If F<Game-SuperSokohire3/ppport.h> was generated using the latest version of
...
# These are tools that must be included in Game-SuperSokohire3/ppport.h.  It doesn't work if given
# a .pl suffix.
#
...
/* Hint: aTHX_
  ...
  through Game-SuperSokohire3/ppport.h */
 ...
 * 5.005 perls, you can use aTHXR (supplied by Game-SuperSokohire3/ppport.h), which will
...
/* Hint: isPSXSPC, isPSXSPC_A, isPSXSPC_L1, isPSXSPC_utf8_safe
    ...
    Game-SuperSokohire3/ppport.h SPACE version does match VT in all perl releases.  Since VT's are
    extremely rarely found in real-life files, this difference effectively
    doesn't matter */

/* Hint: isSPACE, isSPACE_A, isSPACE_L1, isSPACE_utf8_safe
    Until Perl 5.18, this did not match the vertical tab (VT).  The Game-SuperSokohire3/ppport.h
...
/* Hint: SvPVbyte
 * Does not work in perl-5.6.1, Game-SuperSokohire3/ppport.h implements a version
...
/* End of File Game-SuperSokohire3/ppport.h */
